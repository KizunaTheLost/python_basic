...
this_list5 = ["apple" , "banana" , "coconut" , "apple" , "banana" , "coconut"]
this_list5.pop(1)
print(this_list5, len(this_list5))


this_list6 = ["apple" , "banana" , "coconut" , "apple" , "banana" , "coconut"]
del this_list6 [1]
...
this_list7 = ["apple" , "banana" , "coconut" , "apple" , "banana" , "coconut"]
this_list7.sort()
print(this_list7, len(this_list7))
this_list8 = ["apple" , "banana" , "coconut" , "apple" , "banana" , "coconut"]
this_list8.reverse()
